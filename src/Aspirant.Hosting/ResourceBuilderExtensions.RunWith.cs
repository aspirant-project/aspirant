...
public static partial class ResourceBuilderExtensions
{
    ...
    public static IResourceBuilder<TResource> RunWithAnnotation<TResource, TAnnotation>(this IResourceBuilder<TResource> builder, ResourceAnnotationMutationBehavior behavior = ResourceAnnotationMutationBehavior.Append)
    ...
    /// <param name="behavior">The behavior to use when adding the annotation.</param>
    /// <returns>The resource builder.</returns>
    public static IResourceBuilder<TResource> RunWithAnnotation<TResource, TAnnotation>(this IResourceBuilder<TResource> builder, TAnnotation annotation, ResourceAnnotationMutationBehavior behavior = ResourceAnnotationMutationBehavior.Append)
        where TResource : IResource
        where TAnnotation : IResourceAnnotation, new()
    {
        if (builder.ApplicationBuilder.ExecutionContext.IsRunMode)
    ...
    /// <summary>
    /// Allows for the population of environment variables on a resource when <see cref="DistributedApplicationExecutionContext.IsRunMode"/> is <c>true</c>.
    /// </summary>
    /// <typeparam name="TResource">The resource type.</typeparam>
    /// <param name="builder">The resource builder.</param>
    /// <param name="callback">The callback.</param>
    /// <returns>The resource builder.</returns>
    public static IResourceBuilder<TResource> RunWithEnvironment<TResource>(this IResourceBuilder<TResource> builder, Action<EnvironmentCallbackContext> callback)
    ...
    /// <param name="callback">The callback.</param>
    /// <returns>The resource builder.</returns>
    public static IResourceBuilder<TResource> RunWithEnvironment<TResource>(this IResourceBuilder<TResource> builder, Func<EnvironmentCallbackContext, Task> callback)
        where TResource : IResourceWithEnvironment
    {
        if (builder.ApplicationBuilder.ExecutionContext.IsRunMode)
        {
    ...
    /// <summary>
    /// Adds an environment variable to the resource with the endpoint for <paramref name="endpointReference"/> when <see cref="DistributedApplicationExecutionContext.IsRunMode"/> is <c>true</c>.
    /// </summary>
    /// <typeparam name="TResource">The resource type.</typeparam>
    /// <param name="builder">The resource builder.</param>
    ...
    /// <returns>The resource builder.</returns>
    public static IResourceBuilder<TResource> RunWithEnvironment<TResource>(this IResourceBuilder<TResource> builder, string name, EndpointReference endpointReference)
        where TResource : IResourceWithEnvironment
    {
        if (builder.ApplicationBuilder.ExecutionContext.IsRunMode)
        {
    ...
    /// <summary>
    /// Adds an environment variable to the resource when <see cref="DistributedApplicationExecutionContext.IsRunMode"/> is <c>true</c>.
    /// </summary>
    /// <typeparam name="TResource">The resource type.</typeparam>
    /// <param name="builder">The resource builder.</param>
    /// <param name="name">The environment variable name.</param>
    ...
    /// <returns>The resource builder.</returns>
    public static IResourceBuilder<TResource> RunWithEnvironment<TResource>(this IResourceBuilder<TResource> builder, string name, ReferenceExpression value)
        where TResource : IResourceWithEnvironment
    {
        if (builder.ApplicationBuilder.ExecutionContext.IsRunMode)
        {
    ...
    /// <param name="value">The value of the environment variable.</param>
    /// <returns>The resource builder.</returns>
    public static IResourceBuilder<TResource> RunWithEnvironment<TResource>(this IResourceBuilder<TResource> builder, string name, in ReferenceExpression.ExpressionInterpolatedStringHandler value)
        where TResource : IResourceWithEnvironment
    {
        if (builder.ApplicationBuilder.ExecutionContext.IsRunMode)
        {
    ...
    /// <param name="value">The value of the environment variable.</param>
    /// <returns>The resource builder.</returns>
    public static IResourceBuilder<TResource> RunWithEnvironment<TResource>(this IResourceBuilder<TResource> builder, string name, string? value)
        where TResource : IResourceWithEnvironment
    {
        if (builder.ApplicationBuilder.ExecutionContext.IsRunMode)
        {
    ...
    /// </param>
    /// <returns>The resource builder.</returns>
    public static IResourceBuilder<TResource> RunWithEnvironment<TResource>(this IResourceBuilder<TResource> builder, string name, Func<string> callback)
        where TResource : IResourceWithEnvironment
    {
        if (builder.ApplicationBuilder.ExecutionContext.IsRunMode)
        {
    ...
    /// <summary>
    /// Adds an environment variable to the resource with the connection string from the referenced resource when <see cref="DistributedApplicationExecutionContext.IsRunMode"/> is <c>true</c>.
    /// </summary>
    /// <typeparam name="TResource">The resource type.</typeparam>
    /// <param name="builder">The resource builder.</param>
    ...
    /// <returns>The resource builder.</returns>
    public static IResourceBuilder<TResource> RunWithEnvironment<TResource>(this IResourceBuilder<TResource> builder, string envVarName, IResourceBuilder<IResourceWithConnectionString> resource)
        where TResource : IResourceWithEnvironment
    {
        if (builder.ApplicationBuilder.ExecutionContext.IsRunMode)
        {
    ...
    /// <summary>
    /// Adds an environment variable to the resource with the value from parameter when <see cref="DistributedApplicationExecutionContext.IsRunMode"/> is <c>true</c>.
    /// </summary>
    /// <typeparam name="TResource">The resource type.</typeparam>
    /// <param name="builder">The resource builder.</param>
    ...
    /// <returns>The resource builder.</returns>
    public static IResourceBuilder<TResource> RunWithEnvironment<TResource>(this IResourceBuilder<TResource> builder, string name, IResourceBuilder<ParameterResource> parameter)
        where TResource : IResourceWithEnvironment
    {
        if (builder.ApplicationBuilder.ExecutionContext.IsRunMode)
        {
